                   ...
                   <div class="row">
                        ...
                        <div class="col-md-12 p-0 m-0 border">
                            <div class="float-left px-2 py-2">
                                <span class="text-muted font-weight-bold"> <i class="fa fa-cog"></i> Generate Report</span>
                            </div>
                            <div class="float-right px-2 mt-1">
                                <form method="post" action="<?= base_url("regsetup/registration/report/generate")?>" id="reportForm">
                                    <div class="form-row">
                                        <div class="col-4">
                                            <select name="batch_id" id="" class="form-control">
                                                ...
                                                <?php
                                                    foreach($batch as $v){
                                                        ?>    
                                                        <option value="<?= $v->id?>"> <?= $v->batch_name."(".date("h:m A", strtotime($v->batch_start_time))."-".date("h:m A", strtotime($v->batch_end_time)).")" ?> </option>
                                                        <?
                                                    }
                                                ?>
                                            </select>
...
//        e.preventDefault();
//        $.ajax({
//            url: "<?= base_url('regsetup/report')?>", //https://jsonplaceholder.typicode.com/users
//            type: "POST",
//            data: $(this).serialize(),
//            dataType: "json",
//            beforeSend: function(){
...
//                $("#reportedData").html(response["html"]);
//            }
//            
//        });
//    });
